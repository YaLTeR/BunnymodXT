...
namespace CVars
{
	...
	CVarWrapper bxt_hud_healthmeter("bxt_hud_healthmeter", "0");
	CVarWrapper bxt_hud_healthmeter_offset("bxt_hud_healthmeter_offset", "");
	CVarWrapper bxt_hud_healthmeter_anchor("bxt_hud_healthmeter_anchor", "0.5 1");
	...
	const std::vector<CVarWrapper*> allCVars =
	{
		...
		&bxt_hud_healthmeter,
		&bxt_hud_healthmeter_offset,
		&bxt_hud_healthmeter_anchor,
		&bxt_hud_timer,
