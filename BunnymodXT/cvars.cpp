...
namespace CVars
{
	...
	CVarWrapper bxt_hud_editor_status("bxt_hud_editor_status", "0");
	CVarWrapper bxt_hud_editor_status_offset("bxt_hud_editor_status_offset", "");
	CVarWrapper bxt_hud_editor_status_anchor("bxt_hud_editor_status_anchor", "1 0");
	...
	const std::vector<CVarWrapper*> allCVars =
	{
		...
		&bxt_hud_editor_status_offset,
		&bxt_hud_editor_status_anchor
	};
}
