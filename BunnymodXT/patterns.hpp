...
namespace patterns
{
	namespace engine
	{
		...
		PATTERNS(SCR_DrawFPS,
			...
			"CoF-5936",
			"55 8B EC D9 05 ?? ?? ?? ?? D8 1D ?? ?? ?? ?? DF E0 F6 C4 40 75 ?? DD 05 ?? ?? ?? ?? DC 1D ?? ?? ?? ?? DF E0 F6 C4 41",
			"Sven-v525",
			"83 EC 54 A1 ?? ?? ?? ?? 33 C4 89 44 24 ?? D9 05"
		);
		...
		PATTERNS(R_StudioCalcAttachments,
			"HL-SteamPipe",
			"8B 0D ?? ?? ?? ?? 83 B9 ?? ?? ?? ?? 04 7E 1F A1",
			"CoF-5936",
			"55 8B EC 83 EC 08 A1 ?? ?? ?? ?? 83 B8 ?? ?? ?? ?? 04 7E 1A",
			"Sven-v525",
			"A1 ?? ?? ?? ?? 83 B8 ?? ?? ?? ?? 04 7E 1D"
		);
		...
		PATTERNS(SCR_DrawPause,
			...
			"HL-4554",
			"D9 05 ?? ?? ?? ?? D8 1D ?? ?? ?? ?? DF E0 F6 C4 40 75 ?? A1 ?? ?? ?? ?? 85 C0 74 ?? A1"
		);
