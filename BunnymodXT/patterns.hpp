...
namespace Patterns
{
	...
	const MemUtils::ptnvec ptnsVGuiWrap2_ConDPrintf =
	{
		{
			"HL-SteamPipe",
			{
				0x55, 0x8B, 0xEC, 0xA1, '?', '?', '?', '?', 0x85, 0xC0, 0x74, 0x14, 0x8B, 0x55, 0x08, 0x8B, 0x08, 0x52, 0x68, '?', '?', '?', '?', 0x50, 0xFF, 0x51, 0x1C, 0x83, 0xC4, 0x0C, 0x5D, 0xC3, 0x53, 0x56, 0x8B, 0x75, 0x08, 0x57, 0x8B, 0xFE, 0x83, 0xC9, 0xFF, 0x33, 0xC0
			},
			"xxxx????xxxxxxxxxxx????xxxxxxxxxxxxxxxxxxxxxx"
		}
	};

	const MemUtils::ptnvec ptnsVGuiWrap2_ConPrintf =
	{
		{
			"HL-SteamPipe",
			{
				0x55, 0x8B, 0xEC, 0xA1, '?', '?', '?', '?', 0x85, 0xC0, 0x74, 0x14, 0x8B, 0x55, 0x08, 0x8B, 0x08, 0x52, 0x68, '?', '?', '?', '?', 0x50, 0xFF, 0x51, 0x18, 0x83, 0xC4, 0x0C, 0x5D, 0xC3, 0x53, 0x56, 0x8B, 0x75, 0x08, 0x57, 0x8B, 0xFE, 0x83, 0xC9, 0xFF, 0x33, 0xC0
			},
			"xxxx????xxxxxxxxxxx????xxxxxxxxxxxxxxxxxxxxxx"
		}
	};
	...
	const MemUtils::ptnvec ptnsSCR_UpdateScreen =
	{
		{
			"HL-SteamPipe",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x10, 0xA1, '?', '?', '?', '?', 0x56, 0x33, 0xF6, 0x3B, 0xC6, 0x0F, 0x85, 0x10, 0x02, 0x00, 0x00, 0xC7, 0x05, '?', '?', '?', '?', 0x01, 0x00, 0x00, 0x00, 0xE8
			},
			"xxxxxxx????xxxxxxxxxxxxx????xxxxx"
		}
	};

	const MemUtils::ptnvec ptnsPF_GetPhysicsKeyValue =
	{
		{
			"HL-SteamPipe",
			{
				0x55, 0x8B, 0xEC, 0x8B, 0x45, 0x08, 0x50, 0xE8, '?', '?', '?', '?', 0x83, 0xC4, 0x04, 0x83, 0xF8, 0x01, 0x7C, 0x33, 0x3B, 0x05, '?', '?', '?', '?', 0x7F, 0x2B, 0x8D, 0x0C, 0x80, 0xC1, 0xE1, 0x08, 0x03, 0xC8, 0x8D, 0x14, 0x48, 0xA1
			},
...

		{
			"HL-WON",
			{
				0x55, 0x8B, 0xEC, 0x8B, 0x45, 0x08, 0x50, 0xE8, '?', '?', '?', '?', 0x83, 0xC4, 0x04, 0x83, 0xF8, 0x01, 0x7C, 0x34, 0x3B, 0x05, '?', '?', '?', '?', 0x7F, 0x2C, 0x8B, 0x15, '?', '?', '?', '?', 0x8D, 0x0C, 0x80, 0xC1, 0xE1, 0x08
			},
			"xxxxxxxx????xxxxxxxxxx????xxxx????xxxxxx"
		}
	};

	const MemUtils::ptnvec ptnsCL_Move =
	{
		{
			"HL-SteamPipe",
			{
				0x55, 0x8B, 0xEC, 0x81, 0xEC, 0x78, 0x08, 0x00, 0x00, 0xA1, '?', '?', '?', '?', 0x53, 0x56, 0x57, 0x33, 0xFF, 0x3B, 0xC7, 0x0F, 0x84, 0x49, 0x06, 0x00, 0x00, 0x83, 0xF8, 0x01, 0x0F, 0x84, 0x40, 0x06, 0x00, 0x00, 0x83, 0xF8, 0x02, 0x0F, 0x84, 0x37, 0x06, 0x00, 00
			},
	...
	{
		{
			"HL-SteamPipe",
			{
				0xA1, '?', '?', '?', '?', 0x85, 0xC0, 0x74, 0x6F, 0xDD, 0x05, '?', '?', '?', '?', 0xA1, '?', '?', '?', '?', 0x8B, 0x0D, '?', '?', '?', '?', 0xD9, 0x1D, '?', '?', '?', '?', 0xA3, '?', '?', '?', '?', 0x89, 0x0D, '?', '?', '?', '?'
			},
			"x????xxxxxx????x????xx????xx????x????xx????"
		}
	};

	const MemUtils::ptnvec ptnsbuild_number =
	{
		{
			"HL-SteamPipe",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x08, 0xA1, '?', '?', '?', '?', 0x56, 0x33, 0xF6, 0x85, 0xC0, 0x0F, 0x85, 0x9B, 0x00, 0x00, 0x00, 0x53, 0x33, 0xDB, 0x8B, 0x04, 0x9D, '?', '?', '?', '?', 0x8B, 0x0D, '?', '?', '?', '?', 0x6A, 0x03, 0x50, 0x51, 0xE8, 0x01, 0xFE, 0x01, 0x00
			},
			"xxxxxxx????xxxxxxxxxxxxxxxxx????xx????xxxxxxxxx"
		}
	};

	// Server patterns.
	const MemUtils::ptnvec ptnsCTriggerVolume__Spawn =
	{
		{
			"HL-SteamPipe",
			{
				0x56, 0x8B, 0xF1, 0x57, 0x33, 0xFF, 0x8B, 0x46, 0x04, 0x89, 0xB8, 0x0C, 0x01, 0x00, 0x00, 0x8B, 0x4E, 0x04, 0x89, 0xB9, 0x08, 0x01, 0x00, 0x00, 0x8B, 0x46, 0x04
			},
			"xxxxxxxxxxxxxxxxxxxxxxxxxxx"
		}
	};

	const MemUtils::ptnvec ptnsCBasePlayer__ForceClientDllUpdate =
	{
		{
			"HL-SteamPipe",
			{
				0x83, 0xC8, 0xFF, 0xC7, 0x81, 0x6C, 0x04, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x89, 0x81, 0x98, 0x04, 0x00, 0x00, 0x89, 0x81, 0x9C, 0x04, 0x00, 0x00, 0x8B, 0x81, 0x74, 0x04, 0x00, 0x00, 0x0C, 0xC0, 0x89, 0x81, 0x74, 0x04, 0x00, 0x00, 0x33, 0xC0, 0x89, 0x81, 0x78, 0x04, 0x00, 0x00
			},
...

		{
			"OpposingForce",
			{
				0x83, 0xC8, 0xFF, 0x89, 0x81, 0xCC, 0x04, 0x00, 0x00, 0x89, 0x81, 0xD0, 0x04, 0x00, 0x00, 0x8B, 0x81, 0xA8, 0x04, 0x00, 0x00, 0x0C, 0xC0, 0x89, 0x81, 0xA8, 0x04, 0x00, 0x00, 0x33, 0xC0, 0x89, 0x81, 0xAC, 0x04, 0x00, 0x00, 0x89, 0x81, 0x30, 0x03, 0x00, 0x00, 0x8B, 0x01, 0xFF, 0xA0, 0x0C, 0x02, 0x00, 0x00
			},
...

		{
			"HazardousCourse2",
			{
				0x83, 0xC8, 0xFF, 0xC7, 0x81, 0x58, 0x04, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x89, 0x81, 0x84, 0x04, 0x00, 0x00, 0x89, 0x81, 0x88, 0x04, 0x00, 0x00, 0x8B, 0x81, 0x60, 0x04, 0x00, 0x00, 0x0C, 0xC0, 0x89, 0x81, 0x60, 0x04, 0x00, 0x00, 0x33, 0xC0, 0x89, 0x81, 0x64, 0x04, 0x00, 0x00
			},
			"xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
		},

		{
			"Gunman",
			{
				0x8B, 0x91, 0x48, 0x04, 0x00, 0x00, 0x83, 0xC8, 0xFF, 0x89, 0x81, 0x68, 0x04, 0x00, 0x00, 0x89, 0x81, 0x6C, 0x04, 0x00, 0x00, 0x33, 0xC0, 0x80, 0xCA, 0xC0, 0x88, 0x81, 0x79, 0x02, 0x00, 0x00, 0x89, 0x81, 0x4C, 0x04, 0x00, 0x00, 0x89, 0x81, 0xD0, 0x02, 0x00, 0x00, 0x8B, 0x01
			},
			"xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
		}
	};

	const MemUtils::ptnvec ptnsCBasePlayer__TakeDamage =
	{
		{
			"HL-SteamPipe",
			{
				0x83, 0xEC, 0x08, 0x53, 0x8B, 0x5C, 0x24, 0x1C, 0x55, 0x56, 0x8B, 0xF1, 0x57, 0xF6, 0xC3, 0x40, 0x8B, 0x46, 0x04, 0xBF, 0x01, 0x00, 0x00, 0x00, 0xC7, 0x44, 0x24, 0x14, 0x00, 0x00, 0x00, 0x3F, 0x8B, 0x88, 0x60, 0x01, 0x00, 0x00
			},
			"xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
		}
	};

	const MemUtils::ptnvec ptnsCPushable__Move =
	{
		{
			"HL-SteamPipe",
			{
				0x53, 0x56, 0x8B, 0xF1, 0x8B, 0x4C, 0x24, 0x0C, 0x57, 0x33, 0xDB, 0x8B, 0x79, 0x04, 0x8B, 0x87, 0xA4, 0x01, 0x00, 0x00, 0xF6, 0xC4, 0x02, 0x74, 0x3A, 0x8B, 0x87, 0x9C, 0x01, 0x00, 0x00, 0x85, 0xC0, 0x74, 0x30, 0x8D, 0x90, 0x80, 0x00, 0x00, 0x00, 0x8B, 0x46, 0x04
			},
			"xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
		}
	};

	const MemUtils::ptnvec ptnsDispatchRestore =
	{
		{
			"HL-SteamPipe",
			{
				0x81, 0xEC, 0xE0, 0x02, 0x00, 0x00, 0x53, 0x55, 0x8B, 0xAC, 0x24, 0xEC, 0x02, 0x00, 0x00, 0x33, 0xDB, 0x56, 0x3B, 0xEB, 0x57, 0x0F, 0x84, 0xEE, 0x02, 0x00, 0x00, 0x8B, 0x75, 0x7C, 0x3B, 0xF3
			},
	...
	const MemUtils::ptnvec ptnsPMJump =
	{
...

		{
			"BigLolly",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x14, 0xC7, 0x45, 0xF4, 0x00, 0x00, 0x00, 0x00, 0xC7, 0x45, 0xFC, 0x00, 0x00, 0x00, 0x00, 0xA1, '?', '?', '?', '?', 0x83, 0xB8, 0xD0, 0x00, 0x00, 0x00, 0x00, 0x74, 0x1F, 0x8B, 0x0D, '?', '?', '?', '?', 0x8B, 0x91, 0xC8, 0x00, 0x00, 0x00, 0x83, 0xCA, 0x02, 0xA1
			},
	...
	const MemUtils::ptnvec ptnsPMPlayerMove =
	{
...

		{
			"BigLolly",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x0C, 0xC7, 0x45, 0xFC, 0x00, 0x00, 0x00, 0x00, 0xA1, '?', '?', '?', '?', 0x8B, 0x4D, 0x08, 0x89, 0x48, 0x04, 0xE8, '?', '?', '?', '?', 0x8B, 0x15, '?', '?', '?', '?', 0xC7, 0x82, 0x8C, 0x54, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0xA1
			},
			"xxxxxxxxxxxxxx????xxxxxxx????xx????xxxxxxxxxxx"
		}
	};
	...
	const MemUtils::ptnvec ptnsPM_ClipVelocity =
	{
...

		{
			"HL-WON",
			{
				0x8B, 0x4C, 0x24, 0x08, 0x53, 0x33, 0xDB, 0x56, 0xD9, 0x41, 0x08, 0xD8, 0x15, '?', '?', '?', '?', 0x57, 0xDF, 0xE0, 0xF6, 0xC4, 0x41, 0x75, 0x05, 0xBB, 0x01, 0x00, 0x00, 0x00, 0xD8, 0x1D, '?', '?', '?', '?', 0xDF, 0xE0, 0xF6, 0xC4, 0x40, 0x74, 0x03, 0x83, 0xCB, 0x02, 0x8B, 0x44
			},
...

		{
			"BigLolly",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x14, 0x8B, 0x45, 0x0C, 0x8B, 0x48, 0x08, 0x89, 0x4D, 0xF8, 0xC7, 0x45, 0xF0, 0x00, 0x00, 0x00, 0x00, 0xD9, 0x45, 0xF8, 0xD8, 0x1D, '?', '?', '?', '?', 0xDF, 0xE0, 0xF6, 0xC4, 0x41, 0x75, 0x09, 0x8B, 0x55, 0xF0, 0x83, 0xCA, 0x01, 0x89, 0x55, 0xF0, 0xD9, 0x45, 0xF8, 0xD8, 0x1D
			},
			"xxxxxxxxxxxxxxxxxxxxxxxxxxx????xxxxxxxxxxxxxxxxxxxxx"
		}
	};

	const MemUtils::ptnvec ptnsPM_WaterMove =
	{
		{
			"HL-SteamPipe",
			{
				0x8B, 0x15, '?', '?', '?', '?', 0x81, 0xEC, 0xCC, 0x00, 0x00, 0x00, 0x33, 0xC0, 0x8D, 0x4A, 0x20, 0xD9, 0x41, 0xF4, 0xD8, 0x8A, 0x68, 0x54, 0x04, 0x00, 0xD9, 0x82, 0x6C, 0x54, 0x04, 0x00, 0xD8, 0x09, 0x40, 0x83, 0xC1, 0x04
			},
...

		{
			"HL-WON",
			{
				0x8B, 0x0D, '?', '?', '?', '?', 0x81, 0xEC, 0x88, 0x00, 0x00, 0x00, 0x8D, 0x54, 0x24, 0x08, 0x56, 0x8D, 0x41, 0x20, 0xBE, 0x03, 0x00, 0x00, 0x00, 0xD9, 0x40, 0xF4, 0xD8, 0x89, 0x68, 0x54, 0x04, 0x00, 0xD9, 0x00, 0xD8, 0x89
			},
			"xx????xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
		},

		{
			"BigLolly",
			{
				0x55, 0x8B, 0xEC, 0x81, 0xEC, 0xDC, 0x00, 0x00, 0x00, 0x56, 0x57, 0xC7, 0x45, 0x88, 0x00, 0x00, 0x00, 0x00, 0xEB, 0x09, 0x8B, 0x45, 0x88, 0x83, 0xC0, 0x01, 0x89, 0x45, 0x88, 0x83, 0x7D, 0x88, 0x03, 0x7D, 0x3B, 0x8B, 0x4D, 0x88, 0x8B, 0x15
			},
			"xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
		}
	};

	const MemUtils::ptnvec ptnsPM_Ladder =
	{
		{
			"HL-SteamPipe",
			{
				0x8B, 0x0D, '?', '?', '?', '?', 0x83, 0xEC, 0x0C, 0x8B, 0x81, 0x50, 0x0F, 0x02, 0x00, 0x53, 0x55, 0x33, 0xDB, 0x56, 0x57, 0x85, 0xC0, 0x0F, 0x8E, 0x94, 0x00, 0x00, 0x00, 0x33, 0xFF, 0x8B, 0x84, 0x0F, 0x84, 0x0F, 0x02, 0x00
			},
			"xx????xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
		}
	};

	const MemUtils::ptnvec ptnsPM_WalkMove =
	{
		{
			"HL-SteamPipe",
			{
				0x81, 0xEC, 0xE4, 0x00, 0x00, 0x00, 0xA1, '?', '?', '?', '?', 0x53, 0x55, 0x33, 0xED, 0x8B, 0x88, 0x68, 0x54, 0x04, 0x00, 0x8B, 0x90, 0x6C, 0x54, 0x04, 0x00, 0x89, 0x68, 0x1C, 0xA1, '?', '?', '?', '?', 0x89, 0x4C, 0x24, 0x54, 0x56, 0x89, 0x68, 0x28, 0x8B, 0x0D, '?', '?', '?', '?', 0x83, 0xC1, 0x14
			},
			"xxxxxxx????xxxxxxxxxxxxxxxxxxxx????xxxxxxxxxx????xxx"
		}
	};

	const MemUtils::ptnvec ptnsPM_FlyMove =
	{
		{
			"HL-SteamPipe",
			{
				0x81, 0xEC, 0x10, 0x01, 0x00, 0x00, 0x53, 0x55, 0x56, 0x8B, 0x35, '?', '?', '?', '?', 0x33, 0xDB, 0x57, 0x8B, 0x46, 0x5C, 0x8B, 0x4E, 0x60, 0x8B, 0x56, 0x64, 0x89, 0x44, 0x24, 0x18, 0x89, 0x44, 0x24, 0x38, 0x8B, 0x46, 0x10, 0x89, 0x5C, 0x24, 0x10, 0x89, 0x4C, 0x24, 0x1C, 0x89, 0x54, 0x24, 0x20
			},
			"xxxxxxxxxxx????xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
		}
	};

	const MemUtils::ptnvec ptnsPM_AddToTouched =
	{
		{
			"HL-SteamPipe",
			{
				0x56, 0x8B, 0x35, '?', '?', '?', '?', 0x33, 0xC0, 0x57, 0x8B, 0x8E, 0x8C, 0x54, 0x04, 0x00, 0x85, 0xC9, 0x7E, 0x16, 0x8B, 0x7C, 0x24, 0x3C, 0x8D, 0x96, 0xC0, 0x54, 0x04, 0x00, 0x39, 0x3A, 0x74, 0x08, 0x40, 0x83, 0xC2, 0x44
			},
