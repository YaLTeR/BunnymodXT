...
namespace Patterns
{
	...
	const MemUtils::ptnvec ptnsCHud_AddHudElem =
	{
...

		{
			"AG-Client",
			{
				0x56, 0x57, 0x8B, 0x7C, 0x24, 0x0C, 0x85, 0xFF, 0x8B, 0xF1, 0x74, 0x41, 0x6A, 0x08, 0xE8, '?', '?', '?', '?', 0x83, 0xC4, 0x04, 0x85, 0xC0, 0x74, 0x33, 0x33, 0xC9, 0x8B, 0xD0, 0x89, 0x0A, 0x89, 0x4A, 0x04, 0x89, 0x38, 0x8B, 0x0E, 0x85, 0xC9, 0x75, 0x07, 0x5F, 0x89, 0x06, 0x5E, 0xC2
			},
			"xxxxxxxxxxxxxxx????xxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
		}
	};
