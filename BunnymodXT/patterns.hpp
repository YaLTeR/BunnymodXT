...
namespace Patterns
{
	...
	const MemUtils::ptnvec ptnsCvar_DirectSet =
	{
		...
		
		{
			"HL-NGHL",
			{
				0x8B, 0x4C, 0x24, 0x08, 0x81, 0xEC, 0x00, 0x04, 0x00, 0x00, 0x56, 0x8B, 0xB4, 0x24, 0x08, 0x04, 0x00, 0x00, 0x57, 0x8B, 0xF9, 0x85, 0xF6, 0x0F, 0x84, '?', '?', '?', '?', 0x85, 0xC9, 0x0F, 0x84, '?', '?', '?', '?', 0x8A, 0x46, 0x08, 0x84, 0xC0
			},
	...
	const MemUtils::ptnvec ptnsHost_Changelevel_f =
	{
		{
			"HL-SteamPipe",
			{
				0x55, 0x8B, 0xEC, 0x81, 0xEC, 0x80, 0x00, 0x00, 0x00, 0xE8, '?', '?', '?', '?', 0x83, 0xF8, 0x02, 0x7D, 0x11, 0x68, '?', '?', '?', '?', 0xE8, '?', '?', '?', '?', 0x83, 0xC4, 0x04, 0x8B, 0xE5, 0x5D, 0xC3, 0xA1, '?', '?', '?', '?', 0x85, 0xC0, 0x0F, 0x84
			},
			"xxxxxxxxxx????xxxxxx????x????xxxxxxxx????xxxx"
		}
	};
	...
	const MemUtils::ptnvec ptnsran1 =
	{
		{
			"HL-SteamPipe",
			{
				0x8B, 0x0D, '?', '?', '?', '?', 0x56, 0x85, 0xC9, 0x7E, 0x0A, 0x8B, 0x35, '?', '?', '?', '?', 0x85, 0xF6, 0x75, 0x58, 0xF7, 0xD9, 0x83, 0xF9, 0x01, 0x7D, 0x05, 0xB9, 0x01, 0x00, 0x00, 0x00, 0xBE
			},
