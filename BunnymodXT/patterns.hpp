...
namespace patterns
{
	...
	namespace server
	{
		PATTERNS(CTriggerVolume__Spawn,
			...
			"AG-67-Server",
			"55 8B EC 81 EC CC 00 00 00 53 56 57 51 8D 7D ?? B9 03 00 00 00 B8 CC CC CC CC F3 AB 59 89 4D ?? B9 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 45 ?? 8B 48 ?? C7 81 ?? ?? ?? ?? 00 00 00 00 8B 45 ?? 8B 48 ?? C7 81 ?? ?? ?? ?? 00 00 00 00 8B 45 ?? 8B 48 ?? 8B 15 ?? ?? ?? ?? 8B 82 ?? ?? ?? ?? 03 81 ?? ?? ?? ?? 8B F4 50 8B 4D ?? 8B 51 ?? 52 E8 ?? ?? ?? ?? 83 C4 04 50 FF 15 ?? ?? ?? ?? 83 C4 08 3B F4 E8 ?? ?? ?? ?? 8B 45 ?? 8B 48 ?? C7 81 ?? ?? ?? ?? 00 00 00 00"
		);
		...
		PATTERNS(CBasePlayer__ForceClientDllUpdate,
			...
			"DayOfDefeat-Latest",
			"55 8B EC 83 EC 5C 53 56 57 89 4D FC 8B 45 FC C7 80 ?? 04 00 00 FF FF FF FF",
			...
			"AG-67-Server",
			"55 8B EC 81 EC 00 01 00 00 53 56 57 51 8D 7D ?? B9 10 00 00 00 B8 CC CC CC CC F3 AB 59 89 4D ?? B9 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 45 ?? C7 80 ?? ?? ?? ?? FF FF FF FF"
		);
		...
		PATTERNS(CBasePlayer__TakeDamage,
			...
			"AG-67-Server",
			"55 8B EC 81 EC C0 01 00 00 53 56 57 51 8D BD ?? ?? ?? ?? B9 40 00 00 00 B8 CC CC CC CC F3 AB 59 89 4D ?? B9 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 45 ?? 83 B8 ?? ?? ?? ?? 00"
		);
		...
		PATTERNS(CBasePlayer__GiveNamedItem,
			...
			"AG-67-Server",
			"55 8B EC 81 EC E4 00 00 00 53 56 57 51 8D 7D ?? B9 09 00 00 00 B8 CC CC CC CC F3 AB 59 89 4D ?? B9 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 45 ?? 99"
		);
		...
		PATTERNS(CPushable__Move,
			...
			"AG-67-Server",
			"55 8B EC 81 EC 00 01 00 00 53 56 57 51 8D 7D ?? B9 10 00 00 00 B8 CC CC CC CC F3 AB 59 89 4D ?? B9 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 45 ?? 8B 48 ?? 89 4D"
		);
		...
		PATTERNS(CGraph__InitGraph,
			...
			"AG-67-Server",
			"55 8B EC 81 EC CC 00 00 00 53 56 57 51 8D 7D ?? B9 03 00 00 00 B8 CC CC CC CC F3 AB 59 89 4D ?? B9 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 45 ?? C7 00 00 00 00 00 8B 45 ?? C7 40 ?? 00 00 00 00 8B 45 ?? C7 40 ?? 00 00 00 00 8B 45 ?? 83 78 ?? 00"
		);
		...
		PATTERNS(CNihilanth__EmitSphere,
			...
			"AG-67-Server",
			"55 8B EC 81 EC 18 01 00 00 53 56 57 51 8D 7D ?? B9 16 00 00 00 B8 CC CC CC CC F3 AB 59 89 4D ?? B9 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 45 ?? C7 80 ?? ?? ?? ?? 00 00 00 00"
		);
		...
		PATTERNS(CBasePlayer__CheatImpulseCommands,
			...
			"AG-67-Server",
			"55 8B EC 81 EC 54 02 00 00 53 56 57 51"
		);
		...
		PATTERNS(CBaseMonster__Killed,
			...
			"AG-67-Server",
			"55 8B EC 81 EC F0 00 00 00 53 56 57 51 8D 7D ?? B9 0C 00 00 00 B8 CC CC CC CC F3 AB 59 89 4D ?? B9 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 45 ?? 00 00 00 00 C7 45 ?? 00 00 00 00 68 80 00 00 00"
		);
		...
		PATTERNS(CChangeLevel__InTransitionVolume,
			...
			"AG-67-Server",
			"55 8B EC 81 EC E4 00 00 00 53 56 57 8D 7D ?? B9 09 00 00 00 B8 CC CC CC CC F3 AB B9 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 45 ?? 8B 10"
		);
		...
		PATTERNS(AddToFullPack_PVS_Byte,
			...
			"AG-67-Server",
			"55 8B EC 81 EC DC 00 00 00 53 56 57 8D 7D ?? B9 07 00 00 00 B8 CC CC CC CC F3 AB B9 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B 45 ?? 8B 88"
		);
		...
		PATTERNS(CBaseEntity__FireBulletsPlayer,
			...
			"AG-67-Server",
			"55 8B EC 81 EC B0 02 00 00 53 56 57 51"
		);
		...
		PATTERNS(PM_CheckStuck,
			...
			"AG-67-Server",
			"55 8B EC 81 EC DC 01 00 00 53 56 57 8D BD"
		);
	...
	namespace shared
	{
		PATTERNS(PM_Jump,
			...
			"AG-67-Server",
			"55 8B EC 81 EC E8 00 00 00 53 56 57 8D 7D ?? B9 0A 00 00 00 B8 CC CC CC CC F3 AB B9 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 45 ?? 00 00 00 00 C7 45 ?? 00 00 00 00"
		);
		...
		PATTERNS(PM_PreventMegaBunnyJumping,
			...
			"AG-67-Server",
			"55 8B EC 81 EC E4 00 00 00 53 56 57 8D 7D ?? B9 09 00 00 00 B8 CC CC CC CC F3 AB B9 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1"
		);
		...
		PATTERNS(PM_PlayerMove,
			...
			"AG-67-Server",
			"55 8B EC 81 EC FC 00 00 00 53 56 57 8D 7D ?? B9 0F 00 00 00 B8 CC CC CC CC F3 AB A1 ?? ?? ?? ?? 33 C5 89 45 ?? B9 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 45 ?? 00 00 00 00"
		);
		...
		PATTERNS(PM_ClipVelocity,
			...
			"AG-67-Server",
			"55 8B EC 81 EC FC 00 00 00 53 56 57 8D 7D ?? B9 0F 00 00 00 B8 CC CC CC CC F3 AB B9 ?? ?? ?? ?? E8 ?? ?? ?? ?? B8 04 00 00 00"
		);
		...
		PATTERNS(PM_WaterMove,
			...
			"AG-67-Server",
			"55 8B EC 81 EC 54 02 00 00 53 56 57 8D BD"
		);
		...
		PATTERNS(PM_Ladder,
			...
			"AG-67-Server",
			"55 8B EC 81 EC 08 01 00 00 53 56 57 8D 7D ?? B9 12 00 00 00 B8 CC CC CC CC F3 AB A1"
		);
		...
		PATTERNS(PM_AddToTouched,
			...
			"AG-67-Server",
			"55 8B EC 81 EC CC 00 00 00 53 56 57 8D 7D ?? B9 03 00 00 00 B8 CC CC CC CC F3 AB B9 ?? ?? ?? ?? E8 ?? ?? ?? ?? C7 45 ?? 00 00 00 00 EB ?? 8B 45 ?? 83 C0 01 89 45 ?? A1"
		);
	}
}
