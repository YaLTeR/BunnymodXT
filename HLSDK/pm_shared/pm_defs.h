...
const unsigned PM_NORMAL = 0x00000000;
const unsigned PM_STUDIO_IGNORE = 0x00000001; // Skip studio models
const unsigned PM_STUDIO_BOX = 0x00000002;    // Use boxes for non-complex studio models (even in traceline)
const unsigned PM_GLASS_IGNORE = 0x00000004;  // Ignore entities with non-normal rendermode
const unsigned PM_WORLD_ONLY = 0x00000008;    // Only trace against the world
